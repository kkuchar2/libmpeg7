...
try:
    xml1     = extractDescriptorFromData(DescriptorType.CT_BROWSING_D, data1, list([]))
    xml2     = extractDescriptorFromData(DescriptorType.CT_BROWSING_D, data2, list([]))
...
try:
    xml1     = extractDescriptor(DescriptorType.CT_BROWSING_D, "images/lena_color.jpg", list([]))
    xml2     = extractDescriptor(DescriptorType.CT_BROWSING_D, "images/HanSolo.jpg", list([]))
    distance = getDistance(xml1, xml2, list([]))
