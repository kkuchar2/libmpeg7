...
try:
    xml1     = extractDescriptorFromData(DescriptorType.REGION_SHAPE_D, data1, list([]))
    xml2     = extractDescriptorFromData(DescriptorType.REGION_SHAPE_D, data2, list([]))
...
try:
    xml1     = extractDescriptor(DescriptorType.REGION_SHAPE_D, "images/lena_color.jpg", list([]))
    xml2     = extractDescriptor(DescriptorType.REGION_SHAPE_D, "images/HanSolo.jpg", list([]))
    distance = getDistance(xml1, xml2, list([]))
