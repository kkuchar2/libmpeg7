...
void ColorLayout::readFromXML(XMLElement * descriptorElement) {
    ...
    if (p_Y_DC_Coeff == NULL || p_Cb_DC_Coeff == NULL || p_Cr_DC_Coeff == NULL) {
        throw COL_LAY_DC_NODE_ERROR;
    }

    XMLElement * p_Y_AC_Coeff  = NULL;
    XMLElement * p_Cb_AC_Coeff = NULL;
    XMLElement * p_Cr_AC_Coeff = NULL;
    ...
    p_Y_AC_Coeff  = p_Y_AC_Coeff2   != NULL ? p_Y_AC_Coeff2   : 
                    p_Y_AC_Coeff5   != NULL ? p_Y_AC_Coeff5   :
                    p_Y_AC_Coeff9   != NULL ? p_Y_AC_Coeff9   :
                    p_Y_AC_Coeff14  != NULL ? p_Y_AC_Coeff14  :
                    p_Y_AC_Coeff20  != NULL ? p_Y_AC_Coeff20  :
                    p_Y_AC_Coeff27  != NULL ? p_Y_AC_Coeff27  :
                    p_Y_AC_Coeff63  != NULL ? p_Y_AC_Coeff63  : throw COL_LAY_AC_NODE_ERROR;

    p_Cb_AC_Coeff = p_Cb_AC_Coeff2  != NULL ? p_Cb_AC_Coeff2  : 
                    p_Cb_AC_Coeff5  != NULL ? p_Cb_AC_Coeff5  :
                    p_Cb_AC_Coeff9  != NULL ? p_Cb_AC_Coeff9  :
                    p_Cb_AC_Coeff14 != NULL ? p_Cb_AC_Coeff14 :
                    p_Cb_AC_Coeff20 != NULL ? p_Cb_AC_Coeff20 :
                    p_Cb_AC_Coeff27 != NULL ? p_Cb_AC_Coeff27 :
                    p_Cb_AC_Coeff63 != NULL ? p_Cb_AC_Coeff63 : throw COL_LAY_AC_NODE_ERROR;

    p_Cr_AC_Coeff = p_Cr_AC_Coeff2  != NULL ? p_Cr_AC_Coeff2  : 
                    p_Cr_AC_Coeff5  != NULL ? p_Cr_AC_Coeff5  :
                    p_Cr_AC_Coeff9  != NULL ? p_Cr_AC_Coeff9  :
                    p_Cr_AC_Coeff14 != NULL ? p_Cr_AC_Coeff14 :
                    p_Cr_AC_Coeff20 != NULL ? p_Cr_AC_Coeff20 :
                    p_Cr_AC_Coeff27 != NULL ? p_Cr_AC_Coeff27 :
                    p_Cr_AC_Coeff63 != NULL ? p_Cr_AC_Coeff63 : throw COL_LAY_AC_NODE_ERROR;
