...
std::string DominantColor::generateXML() {
	...
	XMLElement * p_SpatialCoherency	= NULL;
	...
	std::vector<XMLElement *> p_Values(resultDescriptorSize, NULL);
	std::vector<XMLElement *> p_ValuesPercentages(resultDescriptorSize, NULL);
	std::vector<XMLElement *> p_ValuesColorValueIndices(resultDescriptorSize, NULL);
	std::vector<XMLElement *> p_ValuesColorVariances(resultDescriptorSize, NULL);
